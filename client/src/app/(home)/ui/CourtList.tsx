...
const courts = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1552674605-db6ffd4facb5?auto=format&fit=crop&w=400&h=300&q=80',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=400&h=300&q=80',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {courts.map((court) => (
          <div key={court.id} className="glass-effect rounded-xl overflow-hidden card-hover shadow">
            ...
            <div className="p-4">
              <h3 className="font-heading font-semibold text-lg mb-2">{court.name}</h3>
